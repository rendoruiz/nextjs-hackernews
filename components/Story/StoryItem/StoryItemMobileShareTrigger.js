...
const StoryItemMobileShareTrigger = ({ storyId }) => {
  ...
  return !navigator.share ? null : (  
    <button 
      ...
      className="col-start-2 justify-self-end self-end relative flex items-center border-brandDefault border-brandButtonOutline rounded-full p-1 text-brandTextSecondary dark:border-brandDarkButtonOutline dark:text-brandDarkBorderSeparator bp420:px-2 sm:hidden"
