...
const CommentPreviewItemContent = ({ commentData, parentData, storyId }) => {
  ...
  return commentData && storyId && (  
    <div className="relative px-4 pt-1 pb-[0.625rem] sm:border-brandDefault sm:border-brandBorder sm:border-t-transparent sm:rounded-b sm:p-2 sm:hover:border-brandBorderHover">
      {/* wrapper link */}
